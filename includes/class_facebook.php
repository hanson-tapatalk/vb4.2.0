 ...
 * @since $Date: 2012-01-09 12:08:39 -0800 (Mon, 09 Jan 2012) $
...
class vB_Facebook
{
	...
	public static function login_facebook_instance()
	{
		...
		{
			// boot up the facebook api
			self::$login_facebook_instance = new vB_Facebook(   $vbulletin->options['facebookapp_id'], 
                                                                $vbulletin->options['facebookapp_secret']);
		}
